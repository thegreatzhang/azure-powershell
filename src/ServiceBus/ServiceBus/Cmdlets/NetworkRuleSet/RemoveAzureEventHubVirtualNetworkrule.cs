...
namespace Microsoft.Azure.Commands.ServiceBus.Commands.NetworkruleSet
{
    ...
    /// </summary>
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "ServiceBusVirtualNetworkRule", DefaultParameterSetName = VirtualNetworkRulePropertiesParameterSet, SupportsShouldProcess = true), OutputType(typeof(PSNetworkRuleSetAttributes))]
    public class RemoveAzureEventHubVNetRule : AzureServiceBusCmdletBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            { 
                WriteError(ServiceBusClient.WriteErrorVirtualNetworkExists("Remove"));
            }
        }
    }
}
